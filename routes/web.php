...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/admin/houses/show', [HouseController::class, 'show_house_admin'])->name("admin_show_house");
    ...
    Route::post('admin/cars', [CarController::class, 'store'])->name("admin_store_car");
